...
wget -O /tmp/pkglist.json https://raw.githubusercontent.com/kmrityunjayneo/storagenode_iocageplugin/master/pkg-list.json 
...
wget -O /tmp/storjadmin.json  https://raw.githubusercontent.com/kmrityunjayneo/storagenode_iocageplugin/master/storj.json 
#iocage fetch -P -n /tmp/storjadmin.json --branch 'master' # Not required

iocage exec storagenode git clone https://github.com/kmrityunjayneo/storagenode_iocageplugin.git /root/storagenode
iocage exec storagenode bash /root/storagenode/post_install.sh standard
